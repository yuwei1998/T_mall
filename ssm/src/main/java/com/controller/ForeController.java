...
//					Collections.sort(products, comparing(Product::get));
	...
	public String login(Model model,@RequestParam("name") String name,@RequestParam("password") 
	...
	public String orderConfirmed(Model model, Integer order_id) {
		...
		return "pages/orderConfirmedPage";
	}
