...
<div class="mallPage" id="mallPage">
    <div class="header">
        <a href="/home">
            <img src="/ssm/img/fore/tmallLogo.png" class="tm-logo">
        </a>
    </div>
</div>
...
<div class="content ">
    <div class="login-banner-wrap" style="width: 100%; background-color: rgb(223, 226, 231);" title="">
        <div class="inner">
            <img src="/ssm/img/fore/loginPage-background.jpg">
        </div>
    </div>

    <div class="form" style="display: block; right: 50px;">
        <div class="form-inner">
            <div class="static-form ">
                ...
                <div class="login-title"><h3>密码登录</h3></div>
                <form action="/ssm/login" class="loginForm " method="post">
                    <div class="field">
