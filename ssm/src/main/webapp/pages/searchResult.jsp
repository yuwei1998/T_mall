    ...
    <div class="searchProducts">
        <div class="filter">
            <a class="fSort"
               ...
               href="/ssm/sortProduct?sort=all&keyword=${param.keyword}">综合</a>
            <a class="fSort"
               <c:if test="${'reviewCount'==param.sort}">class="fSort-cur"</c:if>
               href="/ssm/sortProduct?sort=reviewCount&keyword=${param.keyword}">人气</a>
            <a class="fSort"
               <c:if test="${'date'==param.sort}">class="fSort-cur"</c:if>
               href="/ssm/sortProduct?sort=date&keyword=${param.keyword}">新品</a>
            <a class="fSort"
               <c:if test="${'sale'==param.sort}">class="fSort-cur"</c:if>
               href="/ssm/sortProduct?sort=sale&keyword=${param.keyword}">销量</a>
            <a class="fSort"
               <c:if test="${'price'==param.sort}">class="fSort-cur"</c:if>
               href="/ssm/sortProduct?sort=price&keyword=${param.keyword}">价格</a>
        </div>
            ...
            <div class="product">
                <div class="product-iWrap">
                    <div class="productImg-wrap">
                        <a class="productImg" href="/ssm/showProduct?product_id=${p.id}">
                            <img src="/ssm/img/product/${p.id}/1.jpg">
                        </a>
                    </div>
                    <div style="clear: both;"></div>
                    ...
                    <p class="productTitle">
                        <a href="ssm/showProduct?product_id=${p.id}">${p.name}</a>
                    </p>
